    ...
    <main className="flex-1 flex items-center justify-center bg-paper paper-texture px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-card border border-line rounded-2xl p-8 shadow-sm">
          <h1 className="font-display text-2xl mb-1">Start your room</h1>
          <p className="text-ink-soft text-sm mb-6">A quiet place for your unfinished ideas.</p>

          <form action={formAction} className="space-y-4">
            <div>
              <label className="text-sm text-ink-soft block mb-1.5">Name</label>
              <input
                name="name"
                type="text"
                required
            ...
            >
              {pending ? "Setting up your room…" : "Enter Draftroom"}
            </button>
          </form>
        </div>
