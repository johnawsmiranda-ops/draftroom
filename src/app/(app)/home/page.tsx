...
export default async function HomePage() {
  ...
  return (
    <main className="px-4 sm:px-10 py-12 max-w-5xl mx-auto">
      ...
      <h1 className="font-display text-4xl mb-12">Your creative room.</h1>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-14">
        <Link
          href={projects[0] ? `/projects/${projects[0].id}/write` : "/home"}
        ...
        <Link
          href={projects[0] ? `/projects/${projects[0].id}/glimpses` : "/home"}
